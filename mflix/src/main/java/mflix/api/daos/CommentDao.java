...
public class CommentDao extends AbstractMFlixDao {
    ...
    public CommentDao(
        ...
        this.criticCollection = db.getCollection(COMMENT_COLLECTION, Critic.class).withCodecRegistry(pojoCodecRegistry);
    }
    ...
    public Comment addComment(Comment comment) {
        ...
        // comment.
            ...
            if(comment.getId() == null) {
               throw new IncorrectDaoOperation("falha ");
            }

            if(getComment(comment.getId()) == null){
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        // user own comments
        Bson queryFilter = and( eq("_id", new ObjectId(commentId)),
                                eq("email", email));

        Comment results = commentCollection.find(queryFilter).first();

        if( results != null ){
            results.setEmail(email);
            results.setText(text);
            commentCollection.replaceOne(queryFilter, results);
            return true;
        }
